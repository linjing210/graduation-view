...
(function(){
	// 公司开发环境
	var cfg_dev = {
		api_url: 'http://127.0.0.1:8848/sa-admin-dev/mock',	// 所有ajax请求接口父地址
	...
	// 正式生产环境
	var cfg_prod = {
		api_url: 'http://www.qslinjing.com:8083',
		web_url: 'http://www.baidu.com'
	}
			...
			let exportExcel_fn = function(select, fileName) {
				...
				try{
					...
					for (var i = 0; i < thList.length; i++) {
						// 如果是多选框
						if(thList[i].querySelector('.el-checkbox')||thList[i].querySelector('operation')) {
